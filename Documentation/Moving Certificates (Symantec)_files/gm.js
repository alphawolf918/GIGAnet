...
function mnuBackgroundHover(mid){
	switch(mid){
		case "products":
			document.getElementById("b1").className = "b1hover";
		break;
		case "partners":
			document.getElementById("b2").className = "b2hover";
		break;
		case "support":
			document.getElementById("b3").className = "b3hover";
		break;
		case "about":
			document.getElementById("b4").className = "b4hover";
		break;
	}	
}
function mnuBackgroundRemove(mid){
	if(mid == "products"){document.getElementById("b1").className = "";}
	if(mid == "partners"){document.getElementById("b2").className = "";}
	if(mid == "support"){document.getElementById("b3").className = "";}
	if(mid == "about"){document.getElementById("b4").className = "";}
}