...
INSERT INTO `accounts` VALUES("2","Paul Shannon","pshannon","0","0","1291a","paul.shannon@gigainc.com","2014-07-01","1990-09-18","4782577398","localhost","0","","2016-09-19 10:04:54");
...
INSERT INTO `announcements` VALUES("14","2016 Trade Shows","<p>&nbsp;&nbsp;&nbsp;&nbsp; Shot Show-Las Vegas-Jan 19-23 (Walt &amp; Jeff</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Ausa-Huntsville-Mar 15-17 (Karen &amp; Katie)</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Border Patrol-El Paso-Apr 20-21(Jeff&amp;David M)</p><p>&nbsp;&nbsp;&nbsp;&nbsp; GA Natl Guard-Stone Mtn-Jun 3-6 (Karen, Chloe, David M)</p><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DLA Land &amp; Maritime Supplier Conf &amp; Expo-Aug 29-Sept 1(David W &amp; Katie)</p><p>&nbsp;&nbsp;&nbsp;&nbsp; NGAUS-Baltimore-Sep 9-14</p><p>&nbsp;&nbsp;&nbsp;&nbsp; Ausa-Washington DC-Oct 3-5<br></p>","2015-11-13 12:12:11","<br>");
...
INSERT INTO `calendar` VALUES("539","Jennifer Out"," 4-5","2016-09-22","2016-09-22","spotts","absence");
...
INSERT INTO `im_box` VALUES("13","pshannon","administrator","\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> Ding\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> Derp\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> undefined\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> Test\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> >_<\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> o.0\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> o.0\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :3\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :D\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :v\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :(\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> ....\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> .\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> O:-)\n","1");
INSERT INTO `im_box` VALUES("14","lisa","administrator","","1");
INSERT INTO `im_box` VALUES("15","kferguson","administrator","\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> test\n","0");
INSERT INTO `im_box` VALUES("16","jhathcock","administrator","","1");
INSERT INTO `im_box` VALUES("17","kemery","administrator","","1");
INSERT INTO `im_box` VALUES("18","jeff","administrator","","1");
INSERT INTO `im_box` VALUES("19","administrator","pshannon","\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> Ding\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> Derp\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> undefined\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> Test\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> >_<\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> o.0\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> o.0\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :3\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :D\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :v\n\n<span style=\"font-size: 14px; font-weight: bold;\">Administrator:</span> :(\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> ....\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> .\n\n<span style=\"font-size: 14px; font-weight: bold;\">Paul:</span> O:-)\n","0");
INSERT INTO `im_box` VALUES("20","spotts","administrator","","1");
INSERT INTO `im_box` VALUES("21","amurphy","administrator","","1");



DROP TABLE `message_center`;
...
INSERT INTO `message_center` VALUES("1","2016-07-13 11:32:01","test","::1","test","0");
